	...
	return (
            <div>
                <div className={`${ForgetPasswordCss.boxmodel} forgetPassword_Box` } >
                    <BoxModel title={"FORGET PASSWORD"} sidebar={"cancel"} closeBox={closeBox(0)}>
                ...
                <div className={`${ForgetPasswordCss.boxmodel} forgetPassword_Box`} >
                    <BoxModel title={"FORGET PASSWORD"} sidebar={"cancel"} closeBox={closeBox(1)} >
                ...
                <div className={`${ForgetPasswordCss.boxmodel} forgetPassword_Box` } >
                    <BoxModel title={"FORGET PASSWORD"} sidebar={"cancel"} closeBox={closeBox(2)}>
