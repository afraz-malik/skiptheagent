                    ...
                    <div className={SearchByModelCss.boxmodel_body}>
                        <div className={SearchByModelCss.searchcar}>
                            <div className={SearchByModelCss.uparrow}>
                                <div  onClick={()=>scrollUp()}><img alt='' src="images\rightarrow.png" /></div>
                            </div>
                            <div className={`${SearchByModelCss.search_card_col} modelScroll`} >
                                {
                                    [...Array(5)].map((i, j) =>
                                        <SearchCard key={j} />
                                    )
                            ...
                            <div className={SearchByModelCss.downarrow}>
                                <div  onClick={()=>scrollDown()}><img alt='' src="images\leftarrow.png" /></div>
                            </div>
                        </div>
