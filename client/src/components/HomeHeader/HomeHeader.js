...
const HomeHeader = () =>{
	return (
    <header className ={`${HomeHeaderCss['header']} header`}>
      <img alt='' className ={HomeHeaderCss["headimg"]} src="images\header.jpg" />
        <div  className ={HomeHeaderCss["insidehead"]}>
          <div className ={HomeHeaderCss["tophead"]}>
            ...
            <div className ={HomeHeaderCss["insidetop"]}>
              ...
              <div  className ={HomeHeaderCss["righttop"]}> 
                ...
                <p  className ={HomeHeaderCss["headsecondpimg"]}> Kindly <a href="#dummy">SIGN IN</a> or <a href="#dummy">SIGN UP</a></p>
              </div>
            </div>
            <div className ={HomeHeaderCss["extra1"]}  />
            <div className ={HomeHeaderCss["extra1"]}  />
          ...
          <div className ={HomeHeaderCss["headsearch"]}>
            <form>
              <div className ={HomeHeaderCss[`textsearch search1`]}>
                <input type="text" name="model" placeholder="Car/Make/Model" />
              </div>
              <div  className ={HomeHeaderCss[`citysearch search1`]}>
              ...
              <div  className ={HomeHeaderCss[`pricesearch search1`]}>
                ...
                <div className ={HomeHeaderCss["checkboxes"]}>
                  <input type="checkbox" id={HomeHeaderCss["checkbox1"]} name="new" defaultValue="new" />
                  <label htmlFor="new" className="label1">NEW</label>
                  <input type="checkbox" id={HomeHeaderCss["checkbox1"]} name="new" defaultValue="new" />
                  <label htmlFor="used" className="label2">USED</label>
                </div>
              </div>
